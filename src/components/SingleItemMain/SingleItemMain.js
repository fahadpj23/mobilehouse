                                ...
                                <div className="w-full md:w-5/12  flex-col space-y-4 ">
                                    ...
                                    <div className="space-x-3 flex">
                                    {
                                            ...
                                            context.cart.find(item1 => item1.id === item.id)==undefined ?
                                                <button onClick={()=>localStorage.getItem('UserName') ?  context.userCart(item)  : context.addtocart(item)} className=" w-full rounded font-semibold text-white md:text-base text-sm bg-yellow-400 py-2 md:py-3">Add to Cart+</button>
                                            :
