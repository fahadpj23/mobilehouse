        ...
        <div className="text-center mt-5 ">
                ...
                <div className="flex space-x-3  px-3 items-center h-24 md:h-32">
                        ...
                        <div className="w-6/12 flex flex-col justify-center space-y-3 h-full">
                            <h1 className="text-left text-xs md:text-base font-semibold ">{item.name}</h1>
                        ...
                        <div className=" space-y-6 md:space-y-12 flex flex-col justify-end h-full items-end">
