                                            ...
                                            <div className="flex items-center justify-end w-7/12">
                                                {
                                                    ...
                                                    context.cart.find(item1 => item1.id === item.id)==undefined ?
                                                        <button onClick={()=>context.addtocart(item,item.image)} className=" md:bg-blue-500 text-blue-500 md:text-white focus:outline-none   text-lg md:text-xs py-2 font-semibold rounded px-2 mt-2"><h1 className='md:hidden block  text-2xl '><FaPlus  className="py-1"/></h1><h1 className='md:block hidden'>Add to Cart+</h1></button>
                                                    :
