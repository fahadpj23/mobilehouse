...
const SingleProduct=(props)=>{
    ...
    return(
        <div>
            ...
            <div  className="lg:10/12  w-full  rounded-lg flex flex-col overflow-hidden border border-gray-200 shadow-lg bg-white">
                            <button onClick={()=>singleProductView(item)}  className="h-full items-center justify-center flex flex-col space-y-2 p-2">
