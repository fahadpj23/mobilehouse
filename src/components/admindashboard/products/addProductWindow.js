        ...
        <form onSubmit={(e)=>props.handleSubmit(e)} method="post">
            ...
            <div className=" mt-5 w-full  grid grid-cols-2 gap-6">
                    ...
                    <div className=" text-sm">
                        ...
                        <input defaultValue={product.HSN} type="text" list="data" id="HSN" name="HSN" className="w-full border-2 border-gray-400  rounded-md py-1 px-1" />
                    ...
                    <div className=" text-sm">
                        <h1>Tax</h1>
                        <select defaultValue={product.Tax} className="w-full border-2 border-gray-400  rounded-md py-1 px-1" id="Tax" name="Tax">
