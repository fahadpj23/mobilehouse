                 ...
                 <button onClick={()=>setsidenav(!sidenav)} className={`bg-gray-600 text-white absolute top-0 -right-8 focus:outline-none text-xl p-2`}><GiHamburgerMenu/></button>
                {
                    ...
                    <div className='flex flex-col justify-between h-full'>
                        <div className='space-y-5 px-3 '>
                            <button onClick={()=>history.push({pathname:'/admin/Dashboard',search: "?" + new URLSearchParams({pageNo: 1}).toString() })}  className={` w-full text-left ${LinkAddress=="Dashboard" && " text-blue-500 "  } focus:outline-none flex `}>Dashboard<AiFillDashboard className='mt-1 ml-2'/></button>
                            ...
                            <button  onClick={()=>history.push({pathname:'/admin/HsnCode',search: "?" + new URLSearchParams({pageNo: 1}).toString() })} className={` w-full text-left ${LinkAddress=="HsnCode" && " text-blue-500 "  } focus:outline-none flex `}>HsnCode <GiPayMoney className='mt-1 ml-2 '/></button>
                            <button  onClick={()=>history.push({pathname:'/admin/Heading',search: "?" + new URLSearchParams({pageNo: 1}).toString() })} className={` w-full text-left ${LinkAddress=="Heading" && " text-blue-500 "  } focus:outline-none flex `}>Heading <BsCardHeading className='mt-1 ml-2 '/></button>
                            <button  onClick={()=>history.push({pathname:'/admin/Banner',search: "?" + new URLSearchParams({pageNo: 1}).toString() })} className={` w-full text-left ${LinkAddress=="Banner" && " text-blue-500 "  } focus:outline-none flex `}>Banner <SiBrandfolder className='mt-1 ml-2 '/></button>
                            <button  onClick={()=>history.push({pathname:'/admin/Ads',search: "?" + new URLSearchParams({pageNo: 1}).toString() })} className={` w-full text-left ${LinkAddress=="Ads" && " text-blue-500 "  } focus:outline-none flex `}>Ads <RiAdvertisementLine className='mt-1 ml-2 '/></button>
                        ...
                        <div  className='flex flex-col justify-between h-full'>
                            <div className='space-y-5 px-5 text-xl'>
                                <button  onClick={()=>history.push({pathname:'/admin/Dashboard',search: "?" + new URLSearchParams({pageNo: 1}).toString() })}  className={` mt-10 w-full ${LinkAddress=="Dashboard" && " text-blue-500 "  } focus:outline-none flex justify-center`}><AiFillDashboard/></button>
                                ...
                                <button  onClick={()=>history.push({pathname:'/admin/HsnCode',search: "?" + new URLSearchParams({pageNo: 1}).toString() })}className={` w-full ${LinkAddress=="HsnCode" && " text-blue-500 "  } focus:outline-none flex justify-center`}> <GiPayMoney className='mt-1 ml-2 '/></button>
                                <button  onClick={()=>history.push({pathname:'/admin/Heading',search: "?" + new URLSearchParams({pageNo: 1}).toString() })} className={` w-full ${LinkAddress=="Heading" && " text-blue-500 "  } focus:outline-none flex justify-center`}> <BsCardHeading className='mt-1 ml-2 '/></button>
                                <button  onClick={()=>history.push({pathname:'/admin/Banner',search: "?" + new URLSearchParams({pageNo: 1}).toString() })} className={` w-full ${LinkAddress=="Banner" && " text-blue-500 "  } focus:outline-none flex justify-center`}> <SiBrandfolder className='mt-1 ml-2 '/></button>
                                <button  onClick={()=>history.push({pathname:'/admin/Ads',search: "?" + new URLSearchParams({pageNo: 1}).toString() })} className={` w-full ${LinkAddress=="ads" && " text-blue-500 "  } focus:outline-none flex justify-center`}> <RiAdvertisementLine className='mt-1 ml-2 '/></button>
